...
public class TableDAOImpl extends BaseDAO implements TableDAO {
    ...
    public List<ListDTO> getList() {
        return selectList("TableDetails.getListTableDetails");
    }
    ...
    public List<Map> getTransactionType(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getTransactionType", dynamicQuery);
    }
    ...
    public List<Map> getTransactionID(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getTransactionID", dynamicQuery);
    }

    @Override
    public List<Map> getBranchDraftedTXN(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getBranchDraftedTransaction", dynamicQuery);
    }

    @Override
    public List<Map> getSSCDraftedTXN(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getSSCDraftedTransaction", dynamicQuery);
    }

    @Override
    public List<Map> getBranchPendingTXN(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getBranchPendingTransaction", dynamicQuery);
    }

    @Override
    public List<Map> getSSCPendingTXN(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getSSCPendingTransaction", dynamicQuery);
    }

    @Override
    public List<Map> getAMLPendingTXN(DynamicTable dynamicQuery) {
        return selectList("TableDetails.getAMLPendingTransaction", dynamicQuery);
    }
    ...
    @Override
    public List<Map<String, String>> getCurrencyConfig(){
        return selectList("TableDetails.getCurrencyConfig");
    }
